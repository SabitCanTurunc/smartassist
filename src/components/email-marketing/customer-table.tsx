...
export const CustomerTable = ({
  ...
  return (
    <div className='overflow-auto'>
      ...
      <div className='border rounded-xl border-orangeDark '>
              ...
              <TableRow key={c.id}>
                <TableCell>
                  <Card
                    ...
                    className={cn(
                      ...
                      select.includes(c.email as string) ? 'bg-orangeDark' : 'bg-peach'
                    )}
                  />
                </TableCell>
                ...
                <TableCell>
                  <SideSheet
                    ...
                    trigger={
                      <Card
                        className="bg-grandis py-2 px-4 cursor-pointer text-gray-700 hover:bg-orangeDark"
                        onClick={() => onId(c.id)}
                      >
                        View
                      </Card>
