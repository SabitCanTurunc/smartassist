...
function NavBar() {
  return (
    <div className="flex bg-black gap-5 justify-between items-center px-7 py-1 font-bold border-b border-solid border-zinc-100 leading-[154.5%] max-md:flex-wrap max-md:px-5">
      ...
      <Link
        href="/dashboard"
        className="bg-orangeDark px-4 py-2 rounded-sm text-white"
      >
        Free Trial
      </Link>
    </div>
